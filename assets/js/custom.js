(function ($) {
  ...
  const numbers = ['rc5612', 'Dima66', 'RC897', 'Lorstenapitz'];
  ...
  wapp1.addEventListener('click', function call_wapp(event) {
    let t = event.target;
    if (!t.classList.contains('cross')) {
      let win = window.open(path2, '_blank');
      win.focus();
  ...
  wapp3.addEventListener('click', function call_wapp(event) {
    let t = event.target;
    if (!t.classList.contains('cross')) {
      let win = window.open(path2, '_blank');
      win.focus();
  ...
  wapp4.addEventListener('click', function call_wapp(event) {
    let t = event.target;
    if (!t.classList.contains('cross')) {
      let win = window.open(path2, '_blank');
      win.focus();
